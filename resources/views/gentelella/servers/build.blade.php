            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    @if($user->hasResources())
                        <h3 class="red">Insufficient Resources</h3>
                    @elseif(true)
                        <h3 class="red">We are experiencing some problem in Provider's API we are working to sort it as soon as possible.</h3>
                    @else
                        <form method="post" action="{{ action('ServerController@make') }}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    <select name="os" class="select2_single form-control" tabindex="-1">
