                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                            ...
                            <div class="form-group{{ $errors->has('cpu') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control select" name="cpu">
                                        @for($i=1;$i<=16;$i++)
                            ...
                            <div class="form-group{{ $errors->has('ram') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control select" name="ram">
                                        @for($j=512;$j<=(512*16);$j+=512)
                                            <option value="{{$j}}">{{number_format($j/1024,1)}} GB</option>
                                        @endfor
                                    </select>
                            ...
                            <div class="form-group{{ $errors->has('storage') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control select" name="storage">
                                        @for($k=10;$k<=(10*16);$k+=10)
                                            <option value="{{$k}}">{{$k}} GB</option>
                                        @endfor
                                    </select>
